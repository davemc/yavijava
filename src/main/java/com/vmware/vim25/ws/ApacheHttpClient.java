...
public class ApacheHttpClient extends SoapClient {
	...
	/**
	 * What rolls down stairs alone or in pairs? Its log log log!
	 */
	 ...
	 * <p>
	 * We do true here because by default all the vsphere stuff is self signed.
	 */
	 ...
	 *
	 * @param serverUrl
	 *            <code>String</code> of the url to the vi server
	 * @param ignoreCert
	 *            <code>boolean</code> to check or ignore ssl. Default ignore
	...
	public ApacheHttpClient(String serverUrl, boolean ignoreCert, TrustManager trustManager)
			throws MalformedURLException {
	...
	/**
	 * Invoke a given method with supplied {@link com.vmware.vim25.ws.Argument} on the remote vi server. This method
	 * typically creates the payload needed to send to the vi server. For example you would pass in
	 * RetrieveServiceContent for the methodName, next the params needed for the method. Next give the returnType the
	 * parser should convert the response to in this case the string ServiceContent
	 * <p>
	 * Returns an {@link Object} of the given return type. Using the example above you would get a
	 * {@link com.vmware.vim25.ServiceContent} Object.
	 * <p>
	 *
	 * @param methodName
	 *            Name of the method to execute
	 * @param paras
	 *            Array of Arguments aka params for the method
	 * @param returnType
	 *            String name of the return type
	 * @return Object
	...
	/**
	 * Invoke a given method with supplied {@link com.vmware.vim25.ws.Argument} on the remote vi server. Returns a
	 * {@link StringBuffer} This works the same as the above call except there is no conversion done on the return data
	 * and instead you just get back the StringBuffer content.
	 *
	 * @param methodName
	 *            Name of the method to execute
	 * @param paras
	...
	private InputStream post(String payload) throws IOException {
		...
		if (trustAllSSL) {
			...
			LayeredConnectionSocketFactory sslConnectionSocketFactory = new SSLConnectionSocketFactory(
					CustomSSLTrustContextCreator.getTrustContext(trustManager), new AllowAllHostnameVerifier());
